...
first_id = int(input("Enter a Student ID:"))
first_name = input("Enter a Name:").strip()
first_course = input("Enter a Course:").strip()
second_id = int(input("Enter a Student ID:"))
second_name = input("Enter a Name:").strip()
second_course = input("Enter a Course:").strip()
